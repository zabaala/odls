            ...
            <div className="card">
                <div className="card-body">
                    <div className="text-wrap p-lg-6">
                        ...
                        <h3 id="build-tabler-locally">Build locally</h3>
                        <code>WIP...</code>

                        <h3 id="bugs-and-feature-requests">Bugs and feature requests</h3>
                        <p>Have a bug or a feature request? <a href="https://github.com/zabaala/ui-core/issues/new">Please open a new issue</a>.</p>
                    </div>
                </div>
            </div>
        );
